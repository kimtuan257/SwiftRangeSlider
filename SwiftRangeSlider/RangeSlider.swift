...
@IBDesignable open class RangeSlider: UIControl {
    ...
    @IBInspectable open var charAdvanceInLabel: String = "" {
        didSet {
            updateLabelText()
        }
    }
    ...
    open func updateLabelText() {
        ...
        lowerLabel.string = charAdvanceInLabel + getLabelText(forValue: lowerValue)
        upperLabel.string = charAdvanceInLabel + getLabelText(forValue: upperValue)
